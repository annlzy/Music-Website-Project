...
<body  class="container-fluid">
  <main class=" row">
    ...
    ?>
    <script>
		var element = document.getElementById("topchart");
    ...
    <div class="col-md-9 col-lg-10 col-sm bg-music">
      ...
      <!-- end music player -->
      <div class='m-3'>
      <h3 class="fw-bold">Today's <span class="text-primary">Top Hit</span></h3>
      </div>
      <div class="container mt-4">
        ...
        $sql = "SELECT IdBaiHat, `TenBaiHat`, `HinhBaiHat`, `Audio`, n.TenNgheSi, b.IdTheLoai, t.IdTheLoai, b.LuotNghe
        FROM `baihat` b, nghesi n,  theloai t WHERE b.IdNgheSi = n.IdNgheSi AND t.IdTheLoai = b.IdTheLoai 
        AND b.LuotNghe > 0
        ORDER BY b.LuotNghe DESC";
      ...
      <nav aria-label="Page navigation example">
            ...
            <?php
               echo "<li class='page-item ";
                ...
                echo "'>
                    <a class='page-link' href='topchart.php?page=".($current_page - 1)."'>Previous</a>
                </li>";
                for ($i=1; $i <= $total_page; $i++) {
                    if ($i == $current_page){
                        ...
                        echo "<li class='page-item'><a class='page-link' href='topchart.php?page=".$i."'>".$i."</a></li>";
                    }
                }
                echo "<li class='page-item ";
                if ($current_page == $total_page){
                ...
                echo "'>
                    <a class='page-link' href='topchart.php?page=".($current_page + 1)."'>Next</a>
                </li>";
                ?>
            </ul>
        </nav>
