...
<body class="container-fluid">
  <main class="row">
    ...
    <div class="col-md-9 col-lg-10 col-sm bg-music">
      ...
      <!-- end music player -->
      <div class='m-3'>
      <h4 class="fw-bold">All<span class="text-primary"> Albums</span></h4>
      </div>
      <div class="container mt-4">
        ...
        $sql = "SELECT  a.IdAlbum, a.TenAlbum, a.HinhAlbum, n.TenNgheSi
        FROM `album` a, nghesi n
        WHERE a.IdNgheSi = n.IdNgheSi";
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            echo "<a href = 'music_info.php?id=".$row["IdAlbum"]."' class='text-decoration-none text-black'> <div class='row pb-2'>
                            <div  class='col-7 d-flex flex-row align-items-center justify-content-start '>
                            <div class='col-1'><div class='fs-5 stt'>" . ++$i . "</div></div>
                              <div>
                                
                                <img src = '" . $row['HinhAlbum'] . " 'class='rounded-2' style='width: 3em;'>
                                
                                </div>";
            echo "<div class='ps-3'>
                            <h6 class='m-0'>" . $row["TenAlbum"] . "</h6>";
      ...
      <nav aria-label="Page navigation example">
            ...
            <?php
               echo "<li class='page-item ";
                ...
                echo "'>
                    <a class='page-link' href='album.php?page=".($current_page - 1)."'>Previous</a>
                </li>";
                ...
                echo "'>
                    <a class='page-link' href='album.php?page=".($current_page + 1)."'>Next</a>
                </li>";
                ?>
            </ul>
        </nav>
