...
<body class="container-fluid">
  <main class="row">
    ...
    <div class="col-md-9 col-lg-10 col-sm bg-music">
      ...
      <!-- end music player -->
      <div class='m-3'>
      <h4 class='fw-bold'>Listen<span class='text-primary'> album</span></h4>
      </div>
      <div class="container mt-4">
        ...
        $sql = "SELECT b.IdBaiHat, b.HinhBaiHat, b.TenBaiHat, b.Audio, n.IdNgheSi, n.TenNgheSi, a.TenAlbum
        ...
        echo "<div class='mb-2'>
        <h4 class='fw-bold'>".$row2['TenAlbum']."</h4>
        </div>";
      ...
      <nav aria-label="Page navigation example">
            ...
            <?php
               echo "<li class='page-item ";
                ...
                echo "'>
                    <a class='page-link' href='music_info.php?id=".$idget."&page=".($current_page - 1)."'>Previous</a>
                </li>";
                for ($i=1; $i <= $total_page; $i++) {
                    if ($i == $current_page){
                        ...
                        echo "<li class='page-item'><a class='page-link' href='music_info.php?id=".$idget."&page=".$i."'>".$i."</a></li>";
                    }
                }
                echo "<li class='page-item ";
                if ($current_page == $total_page){
                ...
                echo "'>
                    <a class='page-link' href='music_info.php?id=".$idget."&page=".($current_page + 1)."'>Next</a>
                </li>";
                ?>
            </ul>
        </nav>
