...
<body>
    <main class="row">
        ...
        <div class="col-md-9 col-lg-10 col-sm bg-music">
            ...
            ?>
            <div class='m-3'>
                <h4 class='text-uppercase'>Lịch sử nghe</h4>
            </div>
...
<nav aria-label="Page navigation example">
            ...
            <?php
               echo "<li class='page-item ";
                ...
                echo "'>
                    <a class='page-link' href='history.php?page=".($current_page - 1)."'>Previous</a>
                </li>";
                ...
                echo "'>
                    <a class='page-link' href='history.php?page=".($current_page + 1)."'>Next</a>
                </li>";
                ?>
            </ul>
        </nav>
