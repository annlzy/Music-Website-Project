...
<body  class="container-fluid">
  <main class=" row">
    ...
    <div class="col-md-9 col-lg-10 col-sm bg-music">
      ...
      <!-- end music player -->
      <div class='m-3'>
      <h3 class="fw-bold">Kết quả <span class="text-primary">tìm kiếm</span></h3>
      </div>
      <div class="container mt-4">
        ...
        if(isset($_GET["search"]) && !empty($_GET["search"]))
            {
            $key = $_GET["search"];
            $sql = "SELECT b.IdBaiHat, b.TenBaiHat, n.TenNgheSi, a.TenAlbum,  `HinhBaiHat`, `Audio`
            FROM `baihat` b, nghesi n, album a WHERE  b.IdNgheSi = n.IdNgheSi AND b.IdAlbum = a.IdAlbum AND (a.TenAlbum LIKE '%$key%'  OR b.TenBaiHat LIKE '%$key%'  OR n.TenNgheSi  LIKE '%$key%' )";
            }
            else {
            $sql = "SELECT IdBaiHat, `TenBaiHat`, `HinhBaiHat`, `Audio`, n.TenNgheSi
            FROM `baihat` b, nghesi n WHERE b.IdNgheSi = n.IdNgheSi";
            }
      ...
      <nav aria-label="Page navigation example">
            ...
            <?php
               echo "<li class='page-item ";
                ...
                echo "'>
                    <a class='page-link' href='search.php?page=".($current_page - 1)."'>Previous</a>
                </li>";
                ...
                echo "'>
                    <a class='page-link' href='search.php?page=".($current_page + 1)."'>Next</a>
                </li>";
                ?>
            </ul>
        </nav>
